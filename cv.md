...
```
const peoples = ['Marry', 89534585684, 89038959093, 'Jerry', 'Perry', 'Kerry', 'Garry', 89269036594]

function sortByNameAndNumber(a, b) {
    if (!isNaN(a) && isNaN(b)) {
        return 1
    } else {
        return -1
...
console.log(peoples.sort(sortByNameAndNumber))
```
